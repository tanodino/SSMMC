...
from msc import MSCConfig, MSCModel
...
if __name__ == "__main__":
    ...
    dataloader_test = DataLoader(
        test_dataset, shuffle=False, batch_size=batch_size * 6,   # matches training script's *6
        num_workers=6,
        pin_memory=True,
    ...
    dir_name = os.path.join(dataset_path, "MSC")
    f1_scores = []

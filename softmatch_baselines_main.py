...
from model import SFFCConfig, ScoreFusion, FusionConcat, SoftMatchWeighting
import time
...
if __name__ == "__main__":
    ...
    dir_name = dataset_path+"/SOFTMATCH_%s"%sf_or_fc
    ...
    softmatch = SoftMatchWeighting(num_classes=n_classes, momentum=0.999, n_sigma=2, device=device)
